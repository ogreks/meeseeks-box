...
type Account struct {
	ID           uint64     `gorm:"column:id;type:bigint unsigned;primaryKey;autoIncrement:true;index:idx_email,priority:1;index:idx_last_login_at,priority:1;index:idx_phone,priority:1;index:idx_wait_delete_at,priority:1" json:"id"`
	...
	Phone        string     `gorm:"column:phone;type:varchar(128);comment:带区号的手机号" json:"phone"`                                               // 带区号的手机号
