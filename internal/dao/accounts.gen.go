...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.Aid = field.NewString(tableName, "aid")
	_account.Type = field.NewUint32(tableName, "type")
	_account.CountryCode = field.NewString(tableName, "country_code")
	_account.PurePhone = field.NewString(tableName, "pure_phone")
	_account.Phone = field.NewString(tableName, "phone")
	_account.Email = field.NewString(tableName, "email")
	_account.UserName = field.NewString(tableName, "user_name")
	_account.Password = field.NewString(tableName, "password")
	_account.LastLoginAt = field.NewTime(tableName, "last_login_at")
	_account.IsEnabled = field.NewUint32(tableName, "is_enabled")
	_account.WaitDelete = field.NewUint32(tableName, "wait_delete")
	_account.WaitDeleteAt = field.NewTime(tableName, "wait_delete_at")
	_account.CreatedAt = field.NewTime(tableName, "created_at")
	_account.UpdatedAt = field.NewTime(tableName, "updated_at")
	_account.DeletedAt = field.NewTime(tableName, "deleted_at")
...
type account struct {
	...
	ALL          field.Asterisk
	ID           field.Uint64
	Aid          field.String // 用户唯一ID
	Type         field.Uint32 // 用户类型1.超级管理员/2.普通管理员/3.普通用户
	CountryCode  field.String // 国家区号例如中国86/美国则是1
	PurePhone    field.String // 不带区号的手机号
	Phone        field.String // 带区号的手机号
	Email        field.String // 邮箱
	UserName     field.String // 用户账号(非账号注册随机生成)
	Password     field.String // 密码
	LastLoginAt  field.Time   // 最后登录时间
	IsEnabled    field.Uint32 // 是否启用0.禁用/1.正常
	WaitDelete   field.Uint32 // 等待删除0.否/1.是/2.永久
	WaitDeleteAt field.Time   // 等待删除时间
...
func (a *account) updateTableName(table string) *account {
	...
	a.WaitDelete = field.NewUint32(table, "wait_delete")
	a.WaitDeleteAt = field.NewTime(table, "wait_delete_at")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["pure_phone"] = a.PurePhone
	...
	a.fieldMap["wait_delete"] = a.WaitDelete
	a.fieldMap["wait_delete_at"] = a.WaitDeleteAt
