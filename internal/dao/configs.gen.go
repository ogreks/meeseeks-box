...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.ItemKey = field.NewString(tableName, "item_key")
	_config.ItemValue = field.NewString(tableName, "item_value")
	_config.ItemType = field.NewString(tableName, "item_type")
	_config.ItemTag = field.NewString(tableName, "item_tag")
	_config.IsMultilingual = field.NewUint32(tableName, "is_multilingual")
	_config.IsCustom = field.NewUint32(tableName, "is_custom")
	_config.IsAPI = field.NewUint32(tableName, "is_api")
	_config.CreatedAt = field.NewTime(tableName, "created_at")
	_config.UpdatedAt = field.NewTime(tableName, "updated_at")
	_config.DeletedAt = field.NewTime(tableName, "deleted_at")
...
type config struct {
	...
	ALL            field.Asterisk
	ID             field.Uint64
	ItemKey        field.String // 键名
	ItemValue      field.String // 键值
	ItemType       field.String // 键类型
	ItemTag        field.String // 键标签
	IsMultilingual field.Uint32 // 是否多语言:0.否 / 1.是
	IsCustom       field.Uint32 // 是否为自定义:0.否 / 1.是
	IsAPI          field.Uint32 // 是否接口输出:0.禁止 / 1.允许
...
func (c *config) updateTableName(table string) *config {
	...
	c.ItemKey = field.NewString(table, "item_key")
	c.ItemValue = field.NewString(table, "item_value")
	c.ItemType = field.NewString(table, "item_type")
	c.ItemTag = field.NewString(table, "item_tag")
	c.IsMultilingual = field.NewUint32(table, "is_multilingual")
	c.IsCustom = field.NewUint32(table, "is_custom")
	c.IsAPI = field.NewUint32(table, "is_api")
...
func (c *config) fillFieldMap() {
	...
	c.fieldMap["id"] = c.ID
	c.fieldMap["item_key"] = c.ItemKey
	c.fieldMap["item_value"] = c.ItemValue
	c.fieldMap["item_type"] = c.ItemType
	c.fieldMap["item_tag"] = c.ItemTag
	c.fieldMap["is_multilingual"] = c.IsMultilingual
	c.fieldMap["is_custom"] = c.IsCustom
	c.fieldMap["is_api"] = c.IsAPI
